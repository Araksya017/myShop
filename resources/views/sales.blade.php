    ...
    <nav aria-label="breadcrumb">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ __('messages.акции') }}</li>
            </ol>
        </div>
    </nav>
</div>
                                        ...
                                        <div class="product">
                                            ...
                                            <article>
                                                ...
                                                <div class="pro-description"            style="word-wrap: break-word;
                                                    ...
                                                    <h2 class="pro-title"><a href="{{  route('sale.sale', $item->id)}}">{{ $item->getTranslatedAttribute('title', app()->getLocale())}}</a></h2>
