                            ...
                            <form action="{{ route('register') }}" method="post" name="general-form">
                                ...
                                <div class="from-group  mb-4">
                                    ...
                                    <div class="input-group col-12">
                                        ...
                                        <input type="text" name="name" class="form-control" id="inlineFormInputGroup4" placeholder="{{ __('messages.введите_ваше_имя') }}">
                                    </div>
                                </div>
                                <div class="from-group mb-4">
                                    ...
                                    <div class="input-group col-12">
                                        ...
                                        <input type="text" name="surname" class="form-control" id="inlineFormInputGroup5" placeholder="{{ __('messages.введите_ваше_фамилию') }}">
                                    </div>
                                </div>
                                ...
                                <div class="from-group mb-4">
                                    ...
                                    <div class="input-group col-12">
                                        <select class="form-control" id="inlineFormInputGroup3">
                                            ...
                                            <option value="male">{{ __('messages.мужской') }}</option>
                                            <option value="female">{{ __('messages.женский') }}</option>
                                ...
                                <div class="from-group mb-4">
                                    ...
                                    <div class="input-group col-12">
                                        ...
                                        <input type="text" name="phone" class="form-control" id="inlineFormInputGroup5" placeholder="{{ __('messages.напишите_свой_номер_телефона') }}">
                                    </div>
                                </div>
                                ...
                                <div class="from-group mb-4">
                                    ...
                                    <div class="input-group col-12">
                                        ...
                                        <input type="password" name="password" class="form-control" id="inlineFormInputGroup6" placeholder="{{ __('messages.введите_пароль') }}">
                                    </div>
                                </div>
                                <div class="from-group mb-4">
                                    ...
                                    <div class="input-group col-12">
                                        ...
                                        <input type="password" name="password_confirmation" class="form-control" id="inlineFormInputGroup6" placeholder="{{ __('messages.повторите_пароль') }}">
                                    </div>
                                </div>
